...
class RetrieveThenReadApproach(Approach):
    ...
    template = \
"You are an intelligent assistant helping users with their Azure, Microsoft Cloud Computing platform, questions and other cloud computing platform questions. " + \
